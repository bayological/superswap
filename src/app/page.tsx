              ...
              <CardContent className="space-y-4 pt-6">
                ...
                <div className="rounded-none border border-border/50">
                  <div className="p-4 pb-2">
                    <div className="text-lg text-muted-foreground font-mono mb-2">Sell</div>
                    <div className="flex items-center">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent>
                          <DropdownMenuItem onClick={() => setSellCurrency("USDC")}>USDC</DropdownMenuItem>
                          <DropdownMenuItem onClick={() => setSellCurrency("USDT")}>USDT</DropdownMenuItem>
                          <DropdownMenuItem onClick={() => setSellCurrency("DAI")}>DAI</DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
                    </div>
                    <div className="text-muted-foreground mt-1">${Number.parseFloat(sellAmount).toLocaleString()}</div>
                  </div>
                  ...
                  <div className="p-4 pt-2">
                    <div className="text-lg text-muted-foreground font-mono mb-2">Buy</div>
                    <div className="flex items-center">
                      <Input
                        type="text"
                        value={buyAmount}
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent>
                          <DropdownMenuItem onClick={() => setBuyCurrency("ETH")}>ETH</DropdownMenuItem>
                          <DropdownMenuItem onClick={() => setBuyCurrency("BTC")}>BTC</DropdownMenuItem>
                          <DropdownMenuItem onClick={() => setBuyCurrency("SOL")}>SOL</DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
                    </div>
                    <div className="text-muted-foreground mt-1">$5,999.99</div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center gap-2 text-primary">
                    <div className="flex -space-x-1">
                      ...
                      <div className="w-5 h-5 border border-secondary/50 flex items-center justify-center">
                        <span className="text-secondary text-xs">C</span>
                      </div>
                    </div>
